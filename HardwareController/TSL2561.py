...
class TSL2561(I2C):
	def __init__(self, address=TSL2561_ADDR_LOW, port=1, 
	...
	def calibrate(self):
		...
		x = self.bus.read_byte_data(self.address, TSL2561_REGISTER_ID)
	...
	def enable(self):
		...
		self.bus.write_byte_data(self.address, TSL2561_COMMAND_BIT | TSL2561_REGISTER_CONTROL,
	...
	def _get_data(self):
		...
		broadband = self.bus.read_word_data(self.address, TSL2561_COMMAND_BIT | TSL2561_WORD_BIT |
									 TSL2561_REGISTER_CHAN0_LOW)

		# Reads a two byte value from channel 1 (infrared)
		ir = self.bus.read_word_data(self.address, TSL2561_COMMAND_BIT | TSL2561_WORD_BIT |
	...
	def set_integration_time(self, integration_time):
		...
		self.bus.write_byte_data(self.address, TSL2561_COMMAND_BIT | TSL2561_REGISTER_TIMING,
