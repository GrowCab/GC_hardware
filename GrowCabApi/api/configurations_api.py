...
class ConfigurationsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_configurations = _Endpoint(
            settings={
                'response_type': ([Configuration],),
                'auth': [],
                'endpoint_path': '/api/configurations',
                'operation_id': 'get_configurations',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.put_configuration = _Endpoint(
            settings={
                ...
                'auth': [],
                'endpoint_path': '/api/configurations',
                'operation_id': 'put_configuration',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
